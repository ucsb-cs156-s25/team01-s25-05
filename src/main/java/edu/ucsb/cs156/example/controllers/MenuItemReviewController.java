...
public class MenuItemReviewController extends ApiController {
    ...
    @GetMapping("/all")
    public Iterable<MenuItemReview> allMenuItemReviws() {
     ...
     * 
     * @param itemId the id of a menu item from UCSBDiningCommonsMenuItems
     * @param reviewerEmail the email of the reviewer
     * @param stars the rating in stars (0 to 5)
     * @param dateReviewed the date reviewed
     * @param comments the content of the review
